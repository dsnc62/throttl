...
function ShopCheckout() {
	...
	const form = useForm({
		...
		validators: {
			onBlur: (props) => {
				return checkoutSchema.partial().safeParse(props.value);
			},
	...
	return (
		...
		>
							...
							{(field) => {
								...
								return (
									<Field>
										...
										<Select
											onValueChange={(value) =>
												field.handleChange(value as CheckoutSchema["province"])
											}
											value={field.state.value}
										>
											<SelectTrigger>
			...
			<Button disabled={isLoadingCartTotal || !cartTotal?.total} type="submit">
